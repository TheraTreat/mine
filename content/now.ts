/**
 * The "Now" strip on the home page — the Subjective section of the chart.
 * Keep it to 3–4 short lines and update the date when you edit.
 */
export const now = {
  updated: "July 2026", // TODO: Yog to review — bump whenever you edit the items.
  items: [
